...
[
    {
        "process_title": "Market Research",
        "process_description": "Gathering and analyzing data on consumer preferences, trends, and behaviors to identify
    ...
    {
        "process_title": "Recipe Development",
        "process_description": "Creating and refining recipes for new soft drink products, taking into account factors such as
    ...
    {
        "process_title": "Quality Control",
        "process_description": "Ensuring that new soft drink products meet high standards of quality and consistency, through
    ...
    {
        "process_title": "Packaging Design",
        "process_description": "Creating visually appealing and functional packaging for new soft drink products, taking into
    ...
    {
        "process_title": "Marketing Strategy",
        "process_description": "Developing and executing a marketing strategy for new soft drink products, including
...
BUSINESS_AREA_TO_PROCESSES_MOCK = """
[
    {
        "process_title": "Marketing Campaigns",
        "process_description": "Creating and executing marketing campaigns that promote Fritz-Kola's unique selling proposition,
    ...
    {
        "process_title": "Brand Management",
        "process_description": "Managing the Fritz-Kola brand image and reputation, ensuring that it aligns with the company's
    ...
    {
        "process_title": "Market Research",
        "process_description": "Conducting market research to identify customer preferences and trends, as well as to gather
    ...
    ,
    {
        "process_title": "Content Creation",
        "process_description": "Creating engaging and informative content for marketing campaigns and brand promotion, such as
    ...
    {
        "process_title": "Influencer Marketing",
        "process_description": "Partnering with influencers and brand ambassadors to promote Fritz-Kola and its values to a
        wider audience.",
