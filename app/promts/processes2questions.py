PROCESSES_TO_QUESTIONS_EXAMPLE_INSTRUCTION = "You will receive some strucutred data about a company and one of it's business processes. Come up with a list of five (5) questions that help you as a consultant better understand the process. As these questions are for the business, only ask domain specific questions."
